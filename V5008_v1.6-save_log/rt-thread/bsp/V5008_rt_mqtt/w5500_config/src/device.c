...
static void netshort_to_char(u8* buff_new, u16* buff_old, u16 buff_lenth)
{
	u16 i = 0;
	for(i=0; i<buff_lenth; i++)
	{
		buff_new[i] = buff_old[i];
	}
}
...
//	u16 ip_buff[2] = {0};
//	STMFLASH_Read(W5500_LOCAL_IP, ip_buff,4);
//	netshort_to_char(&falsh_ip[0], ip_buff, 4);
...
//	STMFLASH_Read(W5500_GW_IP, gw_buff,4);
//	netshort_to_char(&falsh_gw[0], gw_buff, 4);

//	STMFLASH_Read(W5500_SUB, sub_buff,4);
//	netshort_to_char(&falsh_dns[0], sub_buff, 4);

//	STMFLASH_Read(W5500_MAC, mac_buff,6);
//	netshort_to_char(&falsh_mac[0], mac_buff, 6);
...
//	STMFLASH_Write(W5500_LOCAL_IP, ip_buff, 4);
//	STMFLASH_Write(W5500_GW_IP, gw_buff, 4);
//	STMFLASH_Write(W5500_SUB, sub_buff, 4);
//	STMFLASH_Write(W5500_MAC, mac_buff, 6);
//	}
//	#endif
